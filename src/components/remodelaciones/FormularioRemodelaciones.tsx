...
export const FormularioRemodelaciones: React.FC<Props> = ({ propiedad, formRef, onValChange, onSubmitSuccess, hideSubmit = false }) => {
...
export default FormularioRemodelaciones;
