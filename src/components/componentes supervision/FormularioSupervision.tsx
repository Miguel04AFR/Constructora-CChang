...
export const FormularioSupervision: React.FC<Props> = ({ formRef, onValChange, onSubmitSuccess, hideSubmit = false }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <h2 className="text-xl font-bold text-[#003153] mb-4">{t('consulting.form.title') || 'Solicitud de supervisión'}</h2>
...
export default FormularioSupervision;
